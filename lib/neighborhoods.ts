...
export const SWISS_DISTRICTS: Neighborhood[] = [
  ...
  // ── Lausanne: the official quartiers (consolidated) ────────────────────────
  {
    name: 'Centre (Cité/Bourg)', parent: 'Lausanne',
    lat: 46.5224, lng: 6.6345,
    walkability: 96, air: 64, green: 55, grocery: 85, transit: 95, safety: 72,
    education: 85, healthcare: 85, dining: 95, quiet: 30, rent: 2300,
    notes: ['Old town', 'Cathedral', 'Car-free lanes', 'Nightlife nearby'],
  },
  {
    name: 'Flon', parent: 'Lausanne',
    lat: 46.5207, lng: 6.6297,
    walkability: 96, air: 62, green: 45, grocery: 85, transit: 98, safety: 68,
    education: 80, healthcare: 85, dining: 96, quiet: 22, rent: 2400,
    notes: ['Metro hub', 'Nightlife platform', 'Modern lofts', 'Loud weekends'],
  },
  {
    name: 'Ouchy', parent: 'Lausanne',
    lat: 46.5074, lng: 6.6262,
    walkability: 85, air: 78, green: 80, grocery: 72, transit: 88, safety: 85,
    education: 80, healthcare: 82, dining: 88, quiet: 55, rent: 2600,
    notes: ['Lakeside promenade', 'Olympic port', 'Metro m2', 'Prestigious'],
  },
  {
    name: 'Sous-gare', parent: 'Lausanne',
    lat: 46.5151, lng: 6.6260,
    walkability: 88, air: 68, green: 60, grocery: 84, transit: 90, safety: 78,
    education: 82, healthcare: 84, dining: 84, quiet: 45, rent: 2200,
    notes: ['Near main station', 'Lively cafes', 'Dense', 'Convenient'],
  },
  {
    name: 'Montoie/Bourdonnette', parent: 'Lausanne',
    lat: 46.5200, lng: 6.6000,
    walkability: 72, air: 74, green: 78, grocery: 68, transit: 78, safety: 74,
    education: 78, healthcare: 78, dining: 62, quiet: 60, rent: 1700,
    notes: ['Near Vidy lakefront', 'Affordable', 'Student housing', 'Mixed area'],
  },
  {
    name: 'Montriond/Cour', parent: 'Lausanne',
    lat: 46.5130, lng: 6.6200,
    walkability: 80, air: 74, green: 78, grocery: 76, transit: 82, safety: 82,
    education: 82, healthcare: 84, dining: 72, quiet: 58, rent: 2100,
    notes: ['Milan park', 'Residential', 'Family friendly', 'Near the lake'],
  },
  {
    name: 'Montchoisi', parent: 'Lausanne',
    lat: 46.5110, lng: 6.6364,
    walkability: 82, air: 76, green: 74, grocery: 76, transit: 82, safety: 86,
    education: 84, healthcare: 84, dining: 76, quiet: 60, rent: 2500,
    notes: ['Elegant', 'Near Ouchy', 'Ice rink', 'Quiet streets'],
  },
  {
    name: 'Chailly', parent: 'Lausanne',
    lat: 46.5252, lng: 6.6545,
    walkability: 70, air: 80, green: 80, grocery: 72, transit: 74, safety: 88,
    education: 84, healthcare: 80, dining: 62, quiet: 72, rent: 2400,
    notes: ['Village feel', 'Residential', 'Family friendly', 'Uphill from center'],
  },
  {
    name: 'Mousquines/Bellevue', parent: 'Lausanne',
    lat: 46.5240, lng: 6.6430,
    walkability: 74, air: 76, green: 76, grocery: 66, transit: 78, safety: 86,
    education: 86, healthcare: 92, dining: 62, quiet: 68, rent: 2400,
    notes: ['Near CHUV', 'Leafy avenues', 'Prestigious', 'Calm'],
  },
  {
    name: 'La Sallaz/Vennes', parent: 'Lausanne',
    lat: 46.5340, lng: 6.6490,
    walkability: 72, air: 76, green: 78, grocery: 74, transit: 84, safety: 80,
    education: 80, healthcare: 84, dining: 62, quiet: 62, rent: 1900,
    notes: ['m2 metro line', 'Near forests', 'Practical', 'Improving'],
  },
  {
    name: 'Borde/Bellevaux', parent: 'Lausanne',
    lat: 46.5355, lng: 6.6320,
    walkability: 72, air: 72, green: 70, grocery: 72, transit: 76, safety: 70,
    education: 76, healthcare: 78, dining: 60, quiet: 58, rent: 1600,
    notes: ['Most affordable', 'Multicultural', 'North slope', 'Improving'],
  },
  {
    name: 'Vinet/Pontaise', parent: 'Lausanne',
    lat: 46.5295, lng: 6.6265,
    walkability: 78, air: 70, green: 66, grocery: 78, transit: 80, safety: 74,
    education: 80, healthcare: 82, dining: 70, quiet: 52, rent: 1900,
    notes: ['Near the stadium', 'Dense residential', 'Local shops', 'Good value'],
  },
  {
    name: 'Beaulieu/Grey', parent: 'Lausanne',
    lat: 46.5290, lng: 6.6220,
    walkability: 78, air: 72, green: 70, grocery: 76, transit: 80, safety: 80,
    education: 82, healthcare: 82, dining: 68, quiet: 58, rent: 2000,
    notes: ['Congress center', 'Established', 'Residential', 'Balanced'],
  },
  {
    name: 'Prélaz/Valency', parent: 'Lausanne',
    lat: 46.5285, lng: 6.6135,
    walkability: 76, air: 68, green: 68, grocery: 78, transit: 82, safety: 72,
    education: 78, healthcare: 78, dining: 66, quiet: 52, rent: 1700,
    notes: ['Affordable west', 'Valency park', 'Tram line', 'Diverse'],
  },
  {
    name: 'Sébeillon/Malley', parent: 'Lausanne',
    lat: 46.5250, lng: 6.6060,
    walkability: 76, air: 64, green: 60, grocery: 74, transit: 86, safety: 70,
    education: 76, healthcare: 78, dining: 66, quiet: 45, rent: 1800,
    notes: ['Prilly-Malley station', 'Regenerating', 'New arena', 'Industrial past'],
  },

  // ── Bern: the six official Stadtteile ──────────────────────────────────────
  {
    name: 'Innere Stadt (Altstadt)', parent: 'Bern',
    lat: 46.9487, lng: 7.4478,
    walkability: 98, air: 70, green: 60, grocery: 84, transit: 96, safety: 84,
    education: 84, healthcare: 88, dining: 95, quiet: 35, rent: 2200,
    notes: ['UNESCO old town', 'Arcades', 'Zytglogge', 'Tourist bustle'],
  },
  {
    name: 'Länggasse/Felsenau', parent: 'Bern',
    lat: 46.9530, lng: 7.4370,
    walkability: 86, air: 78, green: 76, grocery: 80, transit: 88, safety: 88,
    education: 96, healthcare: 88, dining: 80, quiet: 60, rent: 2000,
    notes: ['University quarter', 'Cafe culture', 'Near the Aare', 'Academic'],
  },
  {
    name: 'Mattenhof/Weissenbühl', parent: 'Bern',
    lat: 46.9405, lng: 7.4300,
    walkability: 82, air: 74, green: 72, grocery: 82, transit: 88, safety: 82,
    education: 80, healthcare: 84, dining: 74, quiet: 58, rent: 1800,
    notes: ['Residential', 'Near Europaplatz', 'Family friendly', 'Good value'],
  },
  {
    name: 'Kirchenfeld/Schosshalde', parent: 'Bern',
    lat: 46.9430, lng: 7.4590,
    walkability: 78, air: 82, green: 84, grocery: 72, transit: 82, safety: 92,
    education: 88, healthcare: 86, dining: 70, quiet: 72, rent: 2300,
    notes: ['Embassy quarter', 'Museums', 'Elegant villas', 'Leafy'],
  },
  {
    name: 'Breitenrain/Lorraine', parent: 'Bern',
    lat: 46.9600, lng: 7.4490,
    walkability: 86, air: 74, green: 72, grocery: 84, transit: 88, safety: 80,
    education: 80, healthcare: 82, dining: 82, quiet: 52, rent: 1900,
    notes: ['Trendy Breitsch', 'Aare swimming', 'Wankdorf nearby', 'Lively'],
  },
  {
    name: 'Bümpliz/Oberbottigen', parent: 'Bern',
    lat: 46.9436, lng: 7.3893,
    walkability: 72, air: 74, green: 74, grocery: 78, transit: 82, safety: 70,
    education: 72, healthcare: 76, dining: 62, quiet: 60, rent: 1400,
    notes: ['Most affordable', 'S-Bahn stops', 'Diverse', 'Green edges'],
  },
]
